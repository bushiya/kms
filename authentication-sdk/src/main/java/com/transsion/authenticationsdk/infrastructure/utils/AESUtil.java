...
public class AESUtil {
     ...
     * @throws Exception
     */
    public static String encrypt(String content, String key) throws SdkCustomException {
        try {
            ...
            throw new SdkCustomException(NetCodeEnum.ENCRYPTION_FAILURE);
        }
     ...
     * @throws Exception
     */
    public static String decrypt(String content, String key) throws SdkCustomException {
        try {
            SecretKeySpec keySpec = new SecretKeySpec(key.getBytes(StandardCharsets.UTF_8), ALGORITHM_AES);
            //"算法/模式/补码方式"
            Cipher cipher = Cipher.getInstance(ECB);
            ...
            try {
                ...
                throw new SdkCustomException(NetCodeEnum.DECRYPTION_FAILURE);
            }
        } catch (Exception ex) {
            throw new SdkCustomException(NetCodeEnum.DECRYPTION_FAILURE);
        }
    ...
    public static String Decrypt(String ciphertext, String key) throws Exception {
        ...
        byte[] decryptedBytes = cipher.doFinal(Base64Util.decode(ciphertext));
