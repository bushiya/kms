...
public class RSAUtil {
    ...
    public static RSAPublicKey strByPublicKey(String publicKeyStr) {
        ...
        try {
            ...
            byte[] keyBytes = Base64Util.decode(publicKeyStr);
    ...
    public static RSAPrivateKey strByPrivateKey(String privateKeyStr) {
        ...
        try {
            ...
            byte[] keyBytes1 = Base64Util.decode(privateKeyStr);
    ...
    public static String encryptByPublicKey(String data, String publicKeyStr) {
        ...
        try {
            ...
            result = Base64Util.encode(out.toByteArray());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            return result;
    ...
    public static String decryptByPrivateKey(String data, String privateKeyStr) {
        ...
        try {
            ...
            byte[] decodeData = Base64Util.decode(dataBytes);
    ...
    public static String sign(String data, String privateKeyStr) {
        ...
        try {
            ...
            result = new String(Base64Util.encode(signature.sign()));
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            return result;
    ...
    public static void verify(String srcData, String publicKeyStr, String sign) {
        ...
        try {
            ...
            a = signature.verify(Base64Util.decode(sign.getBytes()));
            if (!a) {
                throw new SdkCustomException(NetCodeEnum.SIGN_VERIFICATION_FAILED);
            }
        } catch (Exception e) {
            throw new SdkCustomException(NetCodeEnum.SIGN_VERIFICATION_FAILED);
        }
