...
public class DeviceController {
    ...
    public CommResponse<SafeChannelResp> safeChannel(@RequestHeader(RequestHeadConst.CIPHER_TAG) String cipherTag,
                                                     @RequestBody @Validated SafeChannelReq req) {
        return CommResponse.success(deviceService.safeChannel(cipherTag, req));
    }
    ...
    public CommResponse<SafeChannelTransmitResp> safeChannelTransmit(@RequestHeader(RequestHeadConst.CIPHER_TAG) String cipherTag,
                                                                     @RequestBody @Validated SafeChannelReq req) throws Exception {
        return CommResponse.success(deviceService.safeChannelTransmit(cipherTag, req));
    }
