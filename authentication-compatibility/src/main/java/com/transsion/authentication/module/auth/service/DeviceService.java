...
public interface DeviceService {
     ...
     * @return
     */
    SafeChannelResp safeChannel(String cipherTag, SafeChannelReq req);
     ...
     * @return
     */
    SafeChannelTransmitResp safeChannelTransmit(String cipherTag,SafeChannelReq req) throws Exception;
