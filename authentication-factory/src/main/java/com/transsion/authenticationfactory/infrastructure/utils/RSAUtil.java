...
public class RSAUtil {
    ...
    public static String sign(String data, String privateKeyStr) {
        ...
        try {
            ...
            result = new String(org.apache.tomcat.util.codec.binary.Base64.encodeBase64(signature.sign()));
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            return result;
    ...
    public static boolean verify(String srcData, String publicKeyStr, String sign) {
        ...
        try {
            ...
            a = signature.verify(org.apache.tomcat.util.codec.binary.Base64.decodeBase64(sign.getBytes()));
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            return a;
